  ...
  const columns: any[] = [
    ...
    },
    {
      ...
      render: (text, record: any, index) => {
        const attrDom = <p className="ellipsis-block ">
        ...
        const noAttr = <p className="ellipsis-block ">
        ...
        return (
          <div className="operation-box">
            ...
            {row.status < 2 ?
              ...
              row.status == 2 && (!row?.dynamicFields?.attributeDataTokenName || !row?.dynamicFields?.dataTokenName) ? <p className="btn pointer link pr10" onClick={toRelease.bind(this, row)}>
